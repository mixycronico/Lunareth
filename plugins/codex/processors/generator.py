...
class CodexGenerator:
    def __init__(self, config):
        ...
        self.config = config
        self.website_output_dir = config.get(
        ...
        self.env = Environment(
            loader=FileSystemLoader("plugins/codex/utils/templates")
        )
    ...
    async def generar_website(self, params: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            template_dir = self.website_templates.get(
                template_type, "utils/templates/react_app"
            )
    ...
    async def generar_plugin(self, params: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            template_dir = self.plugin_templates.get(
                template_type, "utils/templates/plugin"
            )
